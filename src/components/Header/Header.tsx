...
const Header: React.FC<HeaderProps> = (props) => {
  const {
    ...
    removeGovUKHeader = null,
    ...attributes
  } = props;

  let productNameComponent: JSX.Element | null = null;
  let navigationComponent: JSX.Element | null = null;
                ...
                return itemChildren ? (
                  <li
                    ...
                    className={`govuk-header__navigation-item${
                      itemActive ? " govuk-header__navigation-item--active" : ""
                    }`}
                  >
                    {item.href || item.to ? (
                      <LinkWithRef
    ...
    >
      <div className={`govuk-header__container ${containerClassName}`}>
        <div className="govuk-header__logo">
          ...
          >
            {!removeGovUKHeader && <GovUKLogotype />}
            {productNameComponent}
          </LinkWithRef>
        </div>
        {navigationComponent}
